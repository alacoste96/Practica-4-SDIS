...
% PLACEHOLDER: Aquí se incluirá el diagrama de arquitectura general
 \begin{figure}[H]
     \centering
     \includegraphics[width=0.9\textwidth]{../drawio/diagrama_arquitectura.drawio.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../drawio/diagrama_secuencia_completo.drawio.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../drawio/diagrama_secuencia_cliente_servidor.drawio.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../drawio/diagrama_flujo_prioridades.drawio.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../drawio/diagrama_flujo_worker.drawio.pdf}
...
\hline
\textbf{Test} & \textbf{Tiempo Medio (s)} & \textbf{Min (s)} & \textbf{Max (s)} & \textbf{Por Coche (s)} \\ \hline
\endfirsthead
\hline
\textbf{Test} & \textbf{Tiempo Medio (s)} & \textbf{Min (s)} & \textbf{Max (s)} & \textbf{Por Coche (s)} \\ \hline
\endhead
T1 & 107.31 & 99.19 & 113.41 & 3.57 \\ \hline
T2 & 133.55 & 127.68 & 137.66 & 4.45 \\ \hline
T3 & 82.97 & 76.17 & 87.74 & 2.76 \\ \hline
T4 & 153.47 & 148.35 & 159.85 & 5.11 \\ \hline
T5 & 191.88 & 185.35 & 200.31 & 6.39 \\ \hline
T6 & 116.05 & 106.33 & 123.28 & 3.86 \\ \hline
...
\begin{itemize}
    \item \textbf{Canal bufferizado como semáforo}: Solución para gestionar plazas sin locks explícitos.
